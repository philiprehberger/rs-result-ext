...
⭐ [Star the repo](https://github.com/philiprehberger/rs-result-ext)

🐛 [Report issues](https://github.com/philiprehberger/rs-result-ext/issues?q=is%3Aissue+is%3Aopen+label%3Abug)

💡 [Suggest features](https://github.com/philiprehberger/rs-result-ext/issues?q=is%3Aissue+is%3Aopen+label%3Aenhancement)
